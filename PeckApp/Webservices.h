...
#define Size 7
#define DatabaseError @"Application is in under maintenance please check after some time."
#define alertTitle @"Peck: Williams"
...
@interface Webservices : UIViewController
{
